...
| 07 | 19.05. | Mundlak & Within-Between models | tba | tba | Bell, Fairbrother & Jones (2019). [Fixed and random eﬀects models: making an informed choice](https://link.springer.com/article/10.1007/s11135-018-0802-x). Quality & Quantity 53 (2). 1051 - 1074. |
| - | 26.05. | Christi Himmelfahrt | - | - | - |
| 09 | 02.06. | Linear and non-linear probability models | tba | tba | Mood (2010). [Logistic regression: Why we cannot do what we think we can do, and what we can do about it](https://academic.oup.com/esr/article/26/1/67/540767). European Sociological Review 26 (1). 67 - 82. |
